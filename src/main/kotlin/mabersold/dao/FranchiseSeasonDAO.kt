...
interface FranchiseSeasonDAO {
    ...
    suspend fun create(protoFranchiseSeason: ProtoFranchiseSeason): FranchiseSeason?
    suspend fun createAll(protoFranchiseSeasons: List<ProtoFranchiseSeason>): List<FranchiseSeason>
}