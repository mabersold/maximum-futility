...
val `a generic timeline from 1980-1989 with data` = FranchiseTimeline(
    startSeason = 1980,
    endSeason = 1989,
    name = "Denver the Last Dinosaurs",
    league = League.GENERIC,
    metroArea = Metro.DENVER,
    championships = listOf(1985),
    championshipAppearances = listOf(1985, 1986),
    playoffAppearances = listOf(1985, 1986, 1987, 1988),
    advancedInPlayoffs = listOf(1985, 1986),
...
val `a generic timeline from 1990-1999 with data` = FranchiseTimeline(
    startSeason = 1990,
    endSeason = 1999,
    name = "Grand Rapids Top Ten Lists",
    league = League.GENERIC,
    metroArea = Metro.GRAND_RAPIDS,
    championships = listOf(1995),
    championshipAppearances = listOf(1995, 1996),
    playoffAppearances = listOf(1995, 1996, 1997, 1998),
    advancedInPlayoffs = listOf(1995, 1996),
...
val `a generic franchise with two timelines and data` = Franchise(
    name = "Grand Rapids Top Ten Lists",
    firstSeason = 1980,
    isDefunct = false,
    timeline = listOf(`a generic timeline from 1980-1989 with data`, `a generic timeline from 1990-1999 with data`)
)
...
val `a franchise in Decatur` = Franchise(
    name = "Decatur Caterers",
    firstSeason = 1970,
    isDefunct = false,
    timeline = listOf(
        FranchiseTimeline(
...
val `a second franchise in Decatur` = Franchise(
    name = "Decatur Decals",
    firstSeason = 1970,
    isDefunct = false,
    timeline = listOf(
...
val `a city with two generic franchises` = City(
    metroArea = Metro.DECATUR,
    franchises = listOf(
        `a franchise in Decatur`,
        `a second franchise in Decatur`
    )
)
